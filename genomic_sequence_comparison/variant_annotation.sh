...
java -jar snpEff.jar AoH AoH-AoL.delta.snp.vcf > AoH-AoL.delta.snp.anno.vcf
...
java -jar snpEff.jar AoH AoH-AoL.delta.indel.vcf > AoH-AoL.delta.indel.anno.vcf
...
java -jar snpEff.jar AoL AoL-AoH.delta.snp.vcf > AoL-AoH.delta.snp.anno.vcf
...
java -jar snpEff.jar AoL AoL-AoH.delta.indel.vcf > AoL-AoH.delta.indel.anno.vcf
